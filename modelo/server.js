...
class Server {
  ...
  rutas() {
    ...
    this.app.get('/webresources/generic/app/:id', validarJWT, async function (req, res) {
    ...
    this.app.get('/webresources/generic/apps', validarJWT, async function (req, res) {
    ...
    this.app.post('/webresources/generic/app', validarJWT, function (req, res) {
      const body = req.body;
      let miApp = new App(body);
      miApp.save();
      res.json({
        ok: true,
        msg: 'post API apps',
    ...
    //put-apps
    this.app.put('/webresources/generic/app/:id', validarJWT, async function (req, res) {
      const body = req.body;
      const id = req.params.id;
    ...
    //delete apps
    this.app.delete('/webresources/generic/app/:id', validarJWT, async function (req, res) {
      const id = req.params.id;
    ...
    this.app.post(
      ...
      async function (req, res) {
        ...
        if (!req.files.archivo ){
          ...
          const app = {nombre,categoria,precio,imagen}
          console.log(app);
          let miApp = new App(app);
          miApp.save();
